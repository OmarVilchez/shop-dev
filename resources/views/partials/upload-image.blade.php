{{-- resources/views/partials/upload-image.blade.php --}}
<div
    class="border-2 border-dashed rounded-xl p-4 bg-gray-50 dark:bg-zinc-800 border-gray-300 dark:border-zinc-700 flex flex-col items-center justify-center space-y-2 {{ $containerClass ?? '' }}">
